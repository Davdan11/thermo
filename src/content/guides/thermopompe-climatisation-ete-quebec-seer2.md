...
category: "choisir"
keywords: ["thermopompe climatisation été", "SEER2 thermopompe", "thermopompe climatiser", "seer2 signification", "thermopompe déshumidification été"]
related: ["comprendre-seer2-hspf2", "btu-quelle-capacite-choisir", "thermopompe-vs-plinthes-electriques-economies", "murale-ou-centrale"]
faq:
  - q: "Faut-il choisir sa thermopompe pour l'été ou pour l'hiver au Québec?"
    a: "Pour l'hiver. Montréal compte 4 281 degrés-jours de chauffage et Québec 4 977, selon les données climatiques que nous utilisons ; la saison de chauffage domine largement la facture. Le SEER2 est un critère secondaire, utile pour départager deux machines qui se valent déjà à -15 °C."
  - q: "Un SEER2 de 35 vaut-il le prix supplémentaire?"
    a: "Presque jamais pour la facture, parce que la climatisation ne représente qu'une petite part de la consommation annuelle d'une maison québécoise. Les SEER2 les plus élevés de notre catalogue, 35,1 et 35, appartiennent à de petits calibres de 6 000 BTU. Une différence de quelques points de SEER2 change la facture d'été de quelques dollars par mois."
  - q: "Une thermopompe déshumidifie-t-elle mieux qu'un climatiseur?"
    a: "Une thermopompe en mode climatisation est un climatiseur : elle déshumidifie en refroidissant l'air. Elle le fait bien si elle est correctement calibrée et fonctionne longtemps à faible vitesse. Une machine trop grosse refroidit vite, s'arrête, et laisse l'humidité. Le calibre juste compte plus que le SEER2 pour le confort d'été."
  - q: "Quelle consigne d'été est raisonnable?"
    a: "Une consigne stable, sans éteindre la machine le jour pour la relancer le soir. Les appareils à vitesse variable consomment moins en maintenant une température qu'en rattrapant plusieurs degrés. La consigne exacte est une question de confort ; ce qui coûte, c'est la variation, pas le chiffre lui-même."
---
...
Un appareil surdimensionné refroidit la pièce en quelques minutes et s'arrête. La température affichée est atteinte, mais l'air reste lourd. C'est le piège classique du « plus gros, plus sûr » que décrit notre guide sur [la capacité à choisir](/guides/btu-quelle-capacite-choisir). Un appareil calibré sur la charge de chauffage de la maison est en général déjà suffisant en climatisation, parce que la charge de refroidissement d'une maison québécoise est inférieure à sa charge de chauffage.
...
Une murale climatise la zone où elle souffle. Dans une maison à étages, la chaleur monte et la chambre à l'étage reste chaude si la murale est au rez-de-chaussée. C'est souvent en été que les propriétaires découvrent la limite d'un appareil à une seule tête et pensent au multizone ou à la centrale, sujet du guide [murale ou centrale](/guides/murale-ou-centrale).

Le choix du type de système se fait sur la charge de chauffage et la configuration de la maison, mais il faut penser au confort d'été de chaque étage au moment de placer les têtes. Le [comparateur](/comparer) permet de mettre côte à côte le SEER2 et le HSPF2 des configurations envisagées.

## Ce qu'il faut retenir

Le SEER2 est un chiffre honnête : il mesure bien l'efficacité en climatisation. Il est simplement moins décisif au Québec qu'ailleurs, parce que l'été y est court et l'hiver long. Choisissez d'abord une machine qui tient à -15 °C avec un bon COP, calibrée sur la charge réelle de la zone, puis regardez le SEER2 pour départager. Le [questionnaire ThermoMatch](/trouver-ma-thermopompe) applique cet ordre de priorité, et un installateur licencié RBQ confirmera le calibre sur place dans une soumission écrite.

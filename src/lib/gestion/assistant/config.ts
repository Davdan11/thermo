...
/** Repli côté serveur (paramètre « fallbacks ») : seulement pour le modèle par défaut, qui le prend en charge. */
export const usesServerFallbacks = (model: string): boolean => model === CRM_ASSISTANT_DEFAULT_MODEL;

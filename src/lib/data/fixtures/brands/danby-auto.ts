...
export const danbyDataset: BrandDataset = {
  ...
  models: [
    {
      id: "danby-da-series-wall-single",
      slug: "danby-da-series-wall-single",
      name: "DA series",
  ...
  configurations: [
    {
      id: "danby-da-series-wall-single-cfg-1",
      slug: "danby-da-series-wall-single-cfg-1",
      modelId: "danby-da-series-wall-single",
    ...
    {
      id: "danby-da-series-wall-single-cfg-2",
      slug: "danby-da-series-wall-single-cfg-2",
      modelId: "danby-da-series-wall-single",
  ...
  performanceProfiles: [
    {
      configurationId: "danby-da-series-wall-single-cfg-1",
      dataPoints: [
        {
          outdoorTempC: -15,
    ...
    {
      configurationId: "danby-da-series-wall-single-cfg-2",
      dataPoints: [
        {
          outdoorTempC: -15,

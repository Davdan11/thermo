...
export const mapleheatDataset: BrandDataset = {
  ...
  models: [
    {
      id: "maple-heat-ne-t52-series-wall-single",
      slug: "maple-heat-ne-t52-series-wall-single",
      name: "NE-T52 Series",
  ...
  configurations: [
    {
      id: "maple-heat-ne-t52-series-wall-single-cfg-1",
      slug: "maple-heat-ne-t52-series-wall-single-cfg-1",
      modelId: "maple-heat-ne-t52-series-wall-single",
    ...
    {
      id: "maple-heat-ne-t52-series-wall-single-cfg-2",
      slug: "maple-heat-ne-t52-series-wall-single-cfg-2",
      modelId: "maple-heat-ne-t52-series-wall-single",
  ...
  performanceProfiles: [
    {
      configurationId: "maple-heat-ne-t52-series-wall-single-cfg-1",
      dataPoints: [
        {
          outdoorTempC: -15,
    ...
    {
      configurationId: "maple-heat-ne-t52-series-wall-single-cfg-2",
      dataPoints: [
        {
          outdoorTempC: -15,

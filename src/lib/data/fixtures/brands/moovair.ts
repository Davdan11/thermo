...
export const moovairDataset: BrandDataset = {
  brand: { id: "moovair", slug: "moovair", name: "Moovair", countryOfOrigin: "CA", websiteUrl: "https://www.moovair.ca", description: "Marque québécoise reconnue pour ses thermopompes adaptées au climat canadien. Technologie HEAT+ pour chauffage constant jusqu'à -30 °C. R-32 et R-454B disponibles.", activeInQuebec: true, status: "published", createdAt: NOW, updatedAt: NOW, verifiedAt: null },
  ...
  series: [
    { id: "series-moovair-meridian", slug: "moovair-meridian", name: "Meridian HEAT+", brandId: "moovair", systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], description: "Technologie HEAT+ pour chaleur constante jusqu'à -30 °C.", imageUrl: null, status: "published", createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "series-moovair-mistral", slug: "moovair-mistral", name: "Mistral", brandId: "moovair", systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], description: "Option abordable et fiable pour climat froid.", imageUrl: null, status: "published", createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "series-moovair-morelis", slug: "moovair-morelis", name: "Morelis", brandId: "moovair", systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], description: "Gamme supérieure — efficacité maximale avec R-454B.", imageUrl: null, status: "published", createdAt: NOW, updatedAt: NOW, verifiedAt: null },
  ],
  models: [
    // Meridian
    { id: "model-moovair-mdn-9k",  slug: "moovair-meridian-9k",  name: "Meridian 9 000 BTU",  seriesId: "series-moovair-meridian", brandId: "moovair", modelNumber: "MDN-09-INT", normalizedModelNumber: "mdn09int",
      isActive2026: true,
    ...
    { id: "model-moovair-mdn-12k", slug: "moovair-meridian-12k", name: "Meridian 12 000 BTU", seriesId: "series-moovair-meridian", brandId: "moovair", modelNumber: "MDN-12-INT", normalizedModelNumber: "mdn12int",
      isActive2026: true,
    ...
    { id: "model-moovair-mdn-18k", slug: "moovair-meridian-18k", name: "Meridian 18 000 BTU", seriesId: "series-moovair-meridian", brandId: "moovair", modelNumber: "MDN-18-INT", normalizedModelNumber: "mdn18int",
      isActive2026: true,
    ...
    { id: "model-moovair-mdn-24k", slug: "moovair-meridian-24k", name: "Meridian 24 000 BTU", seriesId: "series-moovair-meridian", brandId: "moovair", modelNumber: "MDN-24-INT", normalizedModelNumber: "mdn24int",
      isActive2026: true,
    ...
    // Mistral
    { id: "model-moovair-mst-9k",  slug: "moovair-mistral-9k",  name: "Mistral 9 000 BTU",  seriesId: "series-moovair-mistral", brandId: "moovair", modelNumber: "MST-09-INT", normalizedModelNumber: "mst09int",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 9000,  zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "model-moovair-mst-12k", slug: "moovair-mistral-12k", name: "Mistral 12 000 BTU", seriesId: "series-moovair-mistral", brandId: "moovair", modelNumber: "MST-12-INT", normalizedModelNumber: "mst12int",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 12000, zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    // Morelis
    { id: "model-moovair-mrl-12k", slug: "moovair-morelis-12k", name: "Morelis 12 000 BTU", seriesId: "series-moovair-morelis", brandId: "moovair", modelNumber: "MRL-12-INT", normalizedModelNumber: "mrl12int",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 12000, zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "model-moovair-mrl-18k", slug: "moovair-morelis-18k", name: "Morelis 18 000 BTU", seriesId: "series-moovair-morelis", brandId: "moovair", modelNumber: "MRL-18-INT", normalizedModelNumber: "mrl18int",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 18000, zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
  ],
  outdoorUnits: [
    { id: "ou-moovair-mdn-9k",  modelNumber: "MDN-09-EXT", brandId: "moovair", refrigerant: "R-32" },
    { id: "ou-moovair-mdn-12k", modelNumber: "MDN-12-EXT", brandId: "moovair", refrigerant: "R-32" },
    { id: "ou-moovair-mdn-18k", modelNumber: "MDN-18-EXT", brandId: "moovair", refrigerant: "R-32" },
    { id: "ou-moovair-mdn-24k", modelNumber: "MDN-24-EXT", brandId: "moovair", refrigerant: "R-32" },
    { id: "ou-moovair-mst-9k",  modelNumber: "MST-09-EXT", brandId: "moovair", refrigerant: "R-32" },
    { id: "ou-moovair-mst-12k", modelNumber: "MST-12-EXT", brandId: "moovair", refrigerant: "R-32" },
    { id: "ou-moovair-mrl-12k", modelNumber: "MRL-12-EXT", brandId: "moovair", refrigerant: "R-454B" },
    { id: "ou-moovair-mrl-18k", modelNumber: "MRL-18-EXT", brandId: "moovair", refrigerant: "R-454B" },
  ],
  indoorUnits: [
    { id: "iu-moovair-mdn-9k",  modelNumber: "MDN-09-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mdn-12k", modelNumber: "MDN-12-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mdn-18k", modelNumber: "MDN-18-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mdn-24k", modelNumber: "MDN-24-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mst-9k",  modelNumber: "MST-09-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mst-12k", modelNumber: "MST-12-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mrl-12k", modelNumber: "MRL-12-INT", brandId: "moovair", type: "wall-single" },
    { id: "iu-moovair-mrl-18k", modelNumber: "MRL-18-INT", brandId: "moovair", type: "wall-single" },
  ],
  configurations: [

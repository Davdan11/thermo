...
export const lgDataset: BrandDataset = {
  ...
  series: [
    { id: "series-lg-artcool", slug: "lg-art-cool-mirror", name: "Art Cool Mirror (LGRED°)", brandId: "lg", systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], description: "Design miroir noir élégant avec technologie LGRED° pour climat froid.", imageUrl: null, status: "published", createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "series-lg-standard", slug: "lg-standard-lgred", name: "Standard LGRED°", brandId: "lg", systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], description: "Thermopompe murale LGRED° au design classique.", imageUrl: null, status: "published", createdAt: NOW, updatedAt: NOW, verifiedAt: null },
  ],
  models: [
    { id: "model-lg-artcool-9k",  slug: "lg-art-cool-9k",  name: "Art Cool Mirror 9 000 BTU",  seriesId: "series-lg-artcool", brandId: "lg", modelNumber: "LAN090HSV5", normalizedModelNumber: "lan090hsv5",
      isActive2026: true,
    ...
    { id: "model-lg-artcool-12k", slug: "lg-art-cool-12k", name: "Art Cool Mirror 12 000 BTU", seriesId: "series-lg-artcool", brandId: "lg", modelNumber: "LAN120HSV5", normalizedModelNumber: "lan120hsv5",
      isActive2026: true,
    ...
    { id: "model-lg-artcool-18k", slug: "lg-art-cool-18k", name: "Art Cool Mirror 18 000 BTU", seriesId: "series-lg-artcool", brandId: "lg", modelNumber: "LAN180HSV5", normalizedModelNumber: "lan180hsv5",
      isActive2026: true,
    ...
    { id: "model-lg-std-9k",  slug: "lg-standard-9k",  name: "Standard LGRED° 9 000 BTU",  seriesId: "series-lg-standard", brandId: "lg", modelNumber: "LSN090HSV5", normalizedModelNumber: "lsn090hsv5",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 9000,  zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "model-lg-std-12k", slug: "lg-standard-12k", name: "Standard LGRED° 12 000 BTU", seriesId: "series-lg-standard", brandId: "lg", modelNumber: "LSN120HSV5", normalizedModelNumber: "lsn120hsv5",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 12000, zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
    { id: "model-lg-std-18k", slug: "lg-standard-18k", name: "Standard LGRED° 18 000 BTU", seriesId: "series-lg-standard", brandId: "lg", modelNumber: "LSN180HSV5", normalizedModelNumber: "lsn180hsv5",
      isActive2026: true,
      thermomatchEligible: true, nominalCapacityBtu: 18000, zones: 1, systemType: "wall-single", categories: ["air-air","cold-climate","ductless","single-zone"], status: "published", launchYear: null, discontinuedYear: null, replacedByModelId: null, createdAt: NOW, updatedAt: NOW, verifiedAt: null },
  ],
  outdoorUnits: [
    { id: "ou-lg-artcool-9k",  modelNumber: "LAU090HSV5", brandId: "lg", refrigerant: "R-410A" },
    { id: "ou-lg-artcool-12k", modelNumber: "LAU120HSV5", brandId: "lg", refrigerant: "R-410A" },
    { id: "ou-lg-artcool-18k", modelNumber: "LAU180HSV5", brandId: "lg", refrigerant: "R-410A" },
    { id: "ou-lg-std-9k",  modelNumber: "LSU090HSV5", brandId: "lg", refrigerant: "R-410A" },
    { id: "ou-lg-std-12k", modelNumber: "LSU120HSV5", brandId: "lg", refrigerant: "R-410A" },
    { id: "ou-lg-std-18k", modelNumber: "LSU180HSV5", brandId: "lg", refrigerant: "R-410A" },
  ],
  indoorUnits: [
    { id: "iu-lg-artcool-9k",  modelNumber: "LAN090HSV5", brandId: "lg", type: "wall-single" },
    { id: "iu-lg-artcool-12k", modelNumber: "LAN120HSV5", brandId: "lg", type: "wall-single" },
    { id: "iu-lg-artcool-18k", modelNumber: "LAN180HSV5", brandId: "lg", type: "wall-single" },
    { id: "iu-lg-std-9k",  modelNumber: "LSN090HSV5", brandId: "lg", type: "wall-single" },
    { id: "iu-lg-std-12k", modelNumber: "LSN120HSV5", brandId: "lg", type: "wall-single" },
    { id: "iu-lg-std-18k", modelNumber: "LSN180HSV5", brandId: "lg", type: "wall-single" },
  ],
  configurations: [

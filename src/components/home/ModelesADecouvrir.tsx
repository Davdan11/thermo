...
const PRODUCTS = [
  {
    ...
    seer: "27,5",
    noise: "19",
    img: "/images/products/official/mitsubishi-fs-exterieure-detouree.png",
  ...
  },
  {
    ...
    seer: "28,0",
    noise: "20",
    img: "/images/products/official/daikin-fit-aurora-exterieure-detouree.png",
    imgPos: "center center",
    href: "/marques/daikin",
  },
  {
    ...
    seer: "24,0",
    noise: "22",
    img: "/images/products/official/fujitsu-aouh12kzah1-exterieure-detouree.png",
    imgPos: "center center",
            ...
            {PRODUCTS.map((p, cardIdx) => (
              ...
              >
                ...
                <div style={{ position: "relative", height: 190, backgroundColor: "#f5f3ef", margin: "14px 0 0", overflow: "hidden" }}>
                  <Image
                    src={p.img}
                    alt={`${p.brandName} ${p.modelName}, unité extérieure`}
                    fill
                    sizes="280px"

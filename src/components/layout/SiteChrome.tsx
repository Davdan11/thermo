...
// Volet B : /facture (facture de commission de l'installateur) et /suivi (dossier du client) sont aussi privées.
const PRIVATE_ROUTES: string[] = ["/gestion", "/job", "/devis", "/facture", "/suivi"];

...
// Chantier T : /appel (lien d'alerte au propriétaire) et /rappel (le client choisit son moment de rappel).
const PRIVATE_ROUTES: string[] = ["/gestion", "/job", "/devis", "/facture", "/suivi", "/entente", "/chantier", "/service", "/appel", "/rappel"];

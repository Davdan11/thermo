...
// Volet B : /facture et /suivi ; volet A : /entente, /chantier et /service (« Un problème ? »).
// Chantier P : /projet (portail client « Mon projet ») et /disponibilites (créneaux de l'installateur).
const PRIVATE_ROUTES: string[] = ["/gestion", "/job", "/devis", "/facture", "/suivi", "/entente", "/chantier", "/service", "/projet", "/disponibilites"];

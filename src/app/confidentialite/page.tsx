      ...
      <DocumentBody variant="confidentialite" toc={{ heading: "Sommaire", items: TOC }}>
        ...
        <DocArticle id="renseignements-recueillis" n={2} title="2. Renseignements que nous recueillons">
          <ul>
            ...
            <li><strong>Appels téléphoniques</strong> : numéro de l'appelant, enregistrements des appels et des messages vocaux, lorsque vous appelez notre ligne ou que nous vous rappelons (nos appels passent toujours par le numéro de l’entreprise). Pour résumer votre demande dans votre dossier, l’audio peut être transcrit et résumé automatiquement par Google (Gemini), un fournisseur situé hors du Québec ; l’enregistrement est supprimé au plus tard 90 jours après l’appel.</li>
            ...
            <li><strong>Textos</strong> : si vous nous écrivez par texto au 438-900-3224, nous conservons votre numéro, vos messages et les photos jointes afin de vous répondre et de préparer votre soumission ; répondez ARRÊT (ou STOP) en tout temps pour ne plus recevoir de textos de notre part. Après une demande sur le site, nous pouvons vous envoyer un texto de réponse avec un lien pour choisir le moment de notre appel ; répondez STOP pour ne plus en recevoir.</li>

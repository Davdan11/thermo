/* Accueil de l'outil de gestion : le CRM en un coup d'œil (À faire aujourd'hui, L'argent, Les demandes et leurs
   ...
   Chantier V : ouverte à tous les membres. Un vendeur voit SA version (ses clients seulement, calculée sur l'index
   restreint) et sa carte du classement ; le bloc 05 (commissions des partenaires : l'argent de l'entreprise) reste au
   propriétaire. ?acces=refuse : une section fermée à ce rôle a renvoyé ici. */
